...
@section('admin_main_content')
	...
	<div class="container-fluid">
    	<form action="{{route('floor.update',$data->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
    		@csrf
    		@method('put')
        	<div class="row">
	          	...
	          	<div class="col-md-12 col-sm-12">
		            ...
		            <div class="card card-default">
		                ...
		                <div class="card-footer">
		                  	...
		                  	<a href="{{route('floor.index')}}" class="btn btn-default float-right">Cancel</a>
		                </div>
		                <!-- /.card-footer -->
		            </div>
		            <!-- /.card -->
