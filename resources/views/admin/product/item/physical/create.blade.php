		            ...
		            <div class="card card-default">
			            ...
			            <div class="card-body">
			            	...
			            	<div class="from-group">
								...
								<input type="number" class="form-control" id="adult_capacity" max="5" name="adult_capacity" placeholder="Enter Adult Capacity">
							</div>

							<div class="from-group mt-2">
								<label for="exampleInputEmail1">Child Capacity</label>
								<input type="number" class="form-control" id="child_capacity" max="3" name="child_capacity" placeholder="Enter Child Capacity">
							</div>
			            </div>
		                <!-- /.card-body -->
		            </div>
